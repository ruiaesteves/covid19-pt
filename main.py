...
def main():
    ...
    while command != "SAIR":
        if command == "ACTUALIZAR":
            ...
            negs = int(input("Quantos testes negativos? "))
            days.append(new_day)
            ...
            print("Casos totais:",cumulative_plus[len(cumulative_plus)-1])
            print("Testes totais:",cumulative_total[len(cumulative_total)-1])
            print("% Testes positivos actual:",plus_percentage[len(plus_percentage)-1],"%")
